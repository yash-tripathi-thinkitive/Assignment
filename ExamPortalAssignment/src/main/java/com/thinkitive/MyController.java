...
public class MyController {
	...
	public ExamPages markscalc(@RequestBody ExamPages ep, @RequestParam(name ="sid")Integer sid,@RequestParam(name ="name")String name,Integer marks, @RequestParam(name ="number")Integer number,@RequestParam(name ="correctoption")String correctoption) {
		//System.out.println(ep);
	...
	public ExamPages pages1(@RequestBody ExamPages ep) {
		sq.apperForExam1(ep);
		return ep;
	}
	@GetMapping(value = "/exam2")
	public ExamPages pages2(@RequestBody ExamPages ep) {
		sq.appearForExam2(ep);
		return ep;
	}
	@PostMapping(value = "/status")
	public void status(@RequestBody User u ,@RequestParam(name = "id") String id , @RequestParam(name = "status") String status ) {
	...
	public ModelAndView credentials(@RequestParam(name = "name") String name,@RequestParam(name = "password") String password, @RequestParam(name = "designation") String designation) {
